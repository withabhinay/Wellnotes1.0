...
function App() {
  ...
  return (
    <Router>
      <Routes>
        {/* Route to LandingPage outside of OktoProvider, accessible without auth */}
        <Route path="/" element={<LandingPage />} />

        {/* Routes wrapped inside OktoProvider (protected by authToken check) */}
        <Route
          path="/*" // This path catches all other routes for the protected section
          element={
