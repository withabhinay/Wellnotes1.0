  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <header className="container mx-auto flex items-center justify-between py-2">
        <img src="https://zipbuy.in/img/logo.svg" alt="Wellnotes Logo" width={150} height={50} />
      ...
      <main>
        <section className="container mx-auto text-center py-20">
          ...
          <img src="https://zipbuy.in/img/dashboard.svg" alt="Wellnotes App Interface" width={800} height={600} className="mx-auto" />
        </section>
        ...
        <section className="container mx-auto py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div>
              <img src="https://zipbuy.in/img/1st-feature.png"  alt="Journal Interface" width={400} height={300} />
            </div>
            <div>
        ...
        <section className="container mx-auto py-20 item-center">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className='mx-auto '>
              <img src="https://zipbuy.in/img/secondFeature.svg" alt="Journal Interface" width={400} height={300} />
            </div>           
          </div>
        </section>
        ...
        <section className="container mx-auto py-20">
          ...
          <img src="https://zipbuy.in/img/thirdFeature.svg" alt="Groups Interface" width={800} height={400} className="mx-auto" />
        </section>
      ...
      <footer className="container mx-auto py-10 border-t border-gray-800">
        <div className="flex justify-between">
          <div>
            <img src="https://zipbuy.in/img/logo.svg" alt="Wellnotes Logo" width={120} height={40} />
